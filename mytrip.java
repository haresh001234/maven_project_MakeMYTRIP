...
public class mytrip {
    ...
    @Test(priority = 1)
    public void packagesearch() throws AWTException, InterruptedException {
    	Thread.sleep(10000);
    	...
    	act.click();
    	driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    	driver.findElement(By.xpath("//*[@data-testid='Kolkata']")).click();
    	...
    	driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    	driver.findElement(By.xpath("//*[@aria-label='Mon Nov 20 2023']")).click();
    	driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
    ...
    public void select_package() throws InterruptedException {
    	...
    	if (driver.findElements(By.className("guideContentWrapper")).size() > 0) {
    	    ...
    	    if (closeButton.isDisplayed() && closeButton.isEnabled()) {
    	    	...
    	    	WebElement pack=driver.findElement(By.xpath("(//*[@class='imageSlider'])[3]"));
